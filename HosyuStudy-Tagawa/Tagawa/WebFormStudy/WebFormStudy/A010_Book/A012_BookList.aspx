...
<body>
    <form id="form1" runat="server">
        ...
        <div Class="Content">
            <asp:GridView ID="ShouhinGridView" runat="server" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="ISBN" DataSourceID="sds" ForeColor="#333333" GridLines="None" Width="1200px">
                <AlternatingRowStyle BackColor="White" />
                <Columns>
                    <asp:BoundField DataField="ISBN" HeaderText="ISBN" ReadOnly="True" SortExpression="ISBN" />
                    <asp:BoundField DataField="BookTitle" HeaderText="書籍名" SortExpression="BookTitle" />
            ...
            <asp:SqlDataSource ID="sds" runat="server" ConnectionString="<%$ ConnectionStrings:BookList %>" ></asp:SqlDataSource>
        </div>
        <div Class="Footer">
